...
export const Footer = ({
  ...
  return (
    <footer className="relative z-10 -mt-12 backdrop-blur-sm bg-white/10 border-t border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 py-8 text-center md:pr-20">
      <div className="space-y-3">
        <p className="text-sm">
          {siteName} © {currentYear}. {rightsLabel}
        </p>
        <div className="mt-2 flex justify-center md:mt-0 md:absolute md:right-8 md:top-1/2 md:-translate-y-1/2 md:items-center">
          <a
