...
export interface ApiBlogArticleBlogArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Editorial blog articles for SEO and brand content';
...
export interface ApiBlogCategoryBlogCategory
  ...
  info: {
    description: 'Categories used to organize blog articles';
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Customer orders placed via Stripe Checkout';
    displayName: 'Order';
    pluralName: 'orders';
    singularName: 'order';
  };
  ...
  attributes: {
    ...
    stripePaymentIntentId: Schema.Attribute.String & Schema.Attribute.Private;
